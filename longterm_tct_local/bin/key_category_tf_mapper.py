...
def main(key, min_ts):
    ...
    for line in sys.stdin:
        ...
        try:
            ...
            if 'text_category' not in clickInfo:
                hadoop_counter.increase_counter('map', 'no_text_category')
                continue

            if 'CrimePublicsafety' in clickInfo['text_category'].get('first_cat', {}):
                hadoop_counter.increase_counter('map', 'crime')
                continue

...
STAT_FIELDS = ['sc_channels_v2','channels_v2','text_category']
...
def getDocFeatureWithRetry(docid, retryCnt):
    for i in range(0, retryCnt):
        ...
        if docInfo is not None:
            ...
            if 'channels_v2' in docInfo:
                for chn in docInfo['channels_v2']:
                    #chn v2 are all lower case
                    if any(c.isupper() for c in chn):
                        return None
